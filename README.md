...
The dashboard transforms patient referral data into meaningful insights using KPI
...
<p style ="color:black;"> 4.Compare referral demand across boroughs.</p>
...
<h2 style ="color:green;">Tools and Technologies</h2>
